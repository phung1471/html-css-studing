...
endif; // End of mytheme_header_style.

/**
 * Customize video play/pause button in the custom header.
 */
function mytheme_video_controls( $settings ) {
	$settings['l10n']['play'] = '<span class="screen-reader-text">' . __( 'Play background video', 'mytheme' ) . '</span>' . mytheme_get_svg( array( 'icon' => 'play' ) );
	$settings['l10n']['pause'] = '<span class="screen-reader-text">' . __( 'Pause background video', 'mytheme' ) . '</span>' . mytheme_get_svg( array( 'icon' => 'pause' ) );
	return $settings;
}
