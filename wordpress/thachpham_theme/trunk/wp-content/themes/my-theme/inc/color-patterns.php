 ...
 */
function mytheme_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'mytheme_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.mytheme-front-page) .entry-title,
...
.colors-custom .mytheme-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.mytheme-front-page .panel-content .recent-posts article,
...
.colors-custom.mytheme-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'mytheme_custom_colors_css', $css, $hue, $saturation );
}
